...
public class UserProfileInterests extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileInterests.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileInterests.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileInterests' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileInterests>() {
                @Override
                public void write(JsonWriter out, UserProfileInterests value) throws IOException {
                ...
                @Override
                public UserProfileInterests read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileInterests ret = new UserProfileInterests();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileInterests: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileInterests() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileInterests(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileInterests.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileInterests
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileInterests with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileInterests given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileInterests
     * @throws IOException if the JSON string is invalid with respect to UserProfileInterests
     */
    public static UserProfileInterests fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileInterests.class);
    }

    /**
     * Convert an instance of UserProfileInterests to an JSON string
     *
     * @return JSON string
     */
