...
public class UserProfileRelatedProfileViews extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileRelatedProfileViews.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileRelatedProfileViews.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileRelatedProfileViews' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileRelatedProfileViews>() {
                @Override
                public void write(JsonWriter out, UserProfileRelatedProfileViews value) throws IOException {
                ...
                @Override
                public UserProfileRelatedProfileViews read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileRelatedProfileViews ret = new UserProfileRelatedProfileViews();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileRelatedProfileViews: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileRelatedProfileViews() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileRelatedProfileViews(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileRelatedProfileViews
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileRelatedProfileViews with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileRelatedProfileViews given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileRelatedProfileViews
     * @throws IOException if the JSON string is invalid with respect to UserProfileRelatedProfileViews
     */
    public static UserProfileRelatedProfileViews fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileRelatedProfileViews.class);
    }

    /**
     * Convert an instance of UserProfileRelatedProfileViews to an JSON string
     *
     * @return JSON string
     */
