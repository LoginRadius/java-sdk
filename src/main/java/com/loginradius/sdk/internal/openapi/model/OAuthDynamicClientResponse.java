...
public class OAuthDynamicClientResponse {
  ...
  public OAuthDynamicClientResponse() {
  }

  public OAuthDynamicClientResponse clientName(@javax.annotation.Nonnull String clientName) {
  ...
  public OAuthDynamicClientResponse clientUri(@javax.annotation.Nullable String clientUri) {
  ...
  public OAuthDynamicClientResponse grantTypes(@javax.annotation.Nullable List<String> grantTypes) {
    this.grantTypes = grantTypes;
    return this;
  }

  public OAuthDynamicClientResponse addGrantTypesItem(String grantTypesItem) {
  ...
  public OAuthDynamicClientResponse responseTypes(@javax.annotation.Nullable List<String> responseTypes) {
    this.responseTypes = responseTypes;
    return this;
  }

  public OAuthDynamicClientResponse addResponseTypesItem(String responseTypesItem) {
  ...
  public OAuthDynamicClientResponse redirectUris(@javax.annotation.Nonnull List<String> redirectUris) {
    this.redirectUris = redirectUris;
    return this;
  }

  public OAuthDynamicClientResponse addRedirectUrisItem(String redirectUrisItem) {
  ...
  public OAuthDynamicClientResponse postLogoutRedirectUris(@javax.annotation.Nullable List<String> postLogoutRedirectUris) {
    this.postLogoutRedirectUris = postLogoutRedirectUris;
    return this;
  }

  public OAuthDynamicClientResponse addPostLogoutRedirectUrisItem(String postLogoutRedirectUrisItem) {
  ...
  public OAuthDynamicClientResponse requestUris(@javax.annotation.Nullable List<String> requestUris) {
    this.requestUris = requestUris;
    return this;
  }

  public OAuthDynamicClientResponse addRequestUrisItem(String requestUrisItem) {
  ...
  public OAuthDynamicClientResponse applicationType(@javax.annotation.Nullable ApplicationTypeEnum applicationType) {
  ...
  public OAuthDynamicClientResponse tokenEndpointAuthMethod(@javax.annotation.Nullable TokenEndpointAuthMethodEnum tokenEndpointAuthMethod) {
  ...
  public OAuthDynamicClientResponse scope(@javax.annotation.Nullable String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public OAuthDynamicClientResponse logoUri(@javax.annotation.Nullable String logoUri) {
  ...
  public OAuthDynamicClientResponse tosUri(@javax.annotation.Nullable String tosUri) {
    this.tosUri = tosUri;
    return this;
  }
  ...
  public OAuthDynamicClientResponse policyUri(@javax.annotation.Nullable String policyUri) {
  ...
  public OAuthDynamicClientResponse contacts(@javax.annotation.Nullable List<String> contacts) {
    this.contacts = contacts;
    return this;
  }

  public OAuthDynamicClientResponse addContactsItem(String contactsItem) {
  ...
  public OAuthDynamicClientResponse softwareId(@javax.annotation.Nullable String softwareId) {
  ...
  public OAuthDynamicClientResponse softwareVersion(@javax.annotation.Nullable String softwareVersion) {
  ...
  public OAuthDynamicClientResponse jwksUri(@javax.annotation.Nullable String jwksUri) {
  ...
  public OAuthDynamicClientResponse jwks(@javax.annotation.Nullable Object jwks) {
    this.jwks = jwks;
    return this;
  }
  ...
  public OAuthDynamicClientResponse idTokenSignedResponseAlg(@javax.annotation.Nullable String idTokenSignedResponseAlg) {
  ...
  public OAuthDynamicClientResponse userinfoSignedResponseAlg(@javax.annotation.Nullable String userinfoSignedResponseAlg) {
  ...
  public OAuthDynamicClientResponse backchannelLogoutUri(@javax.annotation.Nullable String backchannelLogoutUri) {
  ...
  public OAuthDynamicClientResponse backchannelLogoutSessionRequired(@javax.annotation.Nullable Boolean backchannelLogoutSessionRequired) {
  ...
  public OAuthDynamicClientResponse clientId(@javax.annotation.Nullable String clientId) {
  ...
  public OAuthDynamicClientResponse clientSecret(@javax.annotation.Nullable String clientSecret) {
  ...
  public OAuthDynamicClientResponse clientIdIssuedAt(@javax.annotation.Nullable Long clientIdIssuedAt) {
  ...
  public OAuthDynamicClientResponse clientSecretExpiresAt(@javax.annotation.Nullable Long clientSecretExpiresAt) {
  ...
  public OAuthDynamicClientResponse registrationAccessToken(@javax.annotation.Nullable String registrationAccessToken) {
  ...
  public OAuthDynamicClientResponse registrationClientUri(@javax.annotation.Nullable String registrationClientUri) {
   ...
   * @return the OAuthDynamicClientResponse instance itself
   */
  public OAuthDynamicClientResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OAuthDynamicClientResponse oauthDynamicClientResponse = (OAuthDynamicClientResponse) o;
    return Objects.equals(this.clientName, oauthDynamicClientResponse.clientName) &&
        Objects.equals(this.clientUri, oauthDynamicClientResponse.clientUri) &&
        Objects.equals(this.grantTypes, oauthDynamicClientResponse.grantTypes) &&
        Objects.equals(this.responseTypes, oauthDynamicClientResponse.responseTypes) &&
        Objects.equals(this.redirectUris, oauthDynamicClientResponse.redirectUris) &&
        Objects.equals(this.postLogoutRedirectUris, oauthDynamicClientResponse.postLogoutRedirectUris) &&
        Objects.equals(this.requestUris, oauthDynamicClientResponse.requestUris) &&
        Objects.equals(this.applicationType, oauthDynamicClientResponse.applicationType) &&
        Objects.equals(this.tokenEndpointAuthMethod, oauthDynamicClientResponse.tokenEndpointAuthMethod) &&
        Objects.equals(this.scope, oauthDynamicClientResponse.scope) &&
        Objects.equals(this.logoUri, oauthDynamicClientResponse.logoUri) &&
        Objects.equals(this.tosUri, oauthDynamicClientResponse.tosUri) &&
        Objects.equals(this.policyUri, oauthDynamicClientResponse.policyUri) &&
        Objects.equals(this.contacts, oauthDynamicClientResponse.contacts) &&
        Objects.equals(this.softwareId, oauthDynamicClientResponse.softwareId) &&
        Objects.equals(this.softwareVersion, oauthDynamicClientResponse.softwareVersion) &&
        Objects.equals(this.jwksUri, oauthDynamicClientResponse.jwksUri) &&
        Objects.equals(this.jwks, oauthDynamicClientResponse.jwks) &&
        Objects.equals(this.idTokenSignedResponseAlg, oauthDynamicClientResponse.idTokenSignedResponseAlg) &&
        Objects.equals(this.userinfoSignedResponseAlg, oauthDynamicClientResponse.userinfoSignedResponseAlg) &&
        Objects.equals(this.backchannelLogoutUri, oauthDynamicClientResponse.backchannelLogoutUri) &&
        Objects.equals(this.backchannelLogoutSessionRequired, oauthDynamicClientResponse.backchannelLogoutSessionRequired) &&
        Objects.equals(this.clientId, oauthDynamicClientResponse.clientId) &&
        Objects.equals(this.clientSecret, oauthDynamicClientResponse.clientSecret) &&
        Objects.equals(this.clientIdIssuedAt, oauthDynamicClientResponse.clientIdIssuedAt) &&
        Objects.equals(this.clientSecretExpiresAt, oauthDynamicClientResponse.clientSecretExpiresAt) &&
        Objects.equals(this.registrationAccessToken, oauthDynamicClientResponse.registrationAccessToken) &&
        Objects.equals(this.registrationClientUri, oauthDynamicClientResponse.registrationClientUri)&&
        Objects.equals(this.additionalProperties, oauthDynamicClientResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientName, clientUri, grantTypes, responseTypes, redirectUris, postLogoutRedirectUris, requestUris, applicationType, tokenEndpointAuthMethod, scope, logoUri, tosUri, policyUri, contacts, softwareId, softwareVersion, jwksUri, jwks, idTokenSignedResponseAlg, userinfoSignedResponseAlg, backchannelLogoutUri, backchannelLogoutSessionRequired, clientId, clientSecret, clientIdIssuedAt, clientSecretExpiresAt, registrationAccessToken, registrationClientUri, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OAuthDynamicClientResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OAuthDynamicClientResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OAuthDynamicClientResponse is not found in the empty JSON string", OAuthDynamicClientResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OAuthDynamicClientResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OAuthDynamicClientResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OAuthDynamicClientResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OAuthDynamicClientResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OAuthDynamicClientResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<OAuthDynamicClientResponse>() {
           @Override
           public void write(JsonWriter out, OAuthDynamicClientResponse value) throws IOException {
           ...
           @Override
           public OAuthDynamicClientResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             OAuthDynamicClientResponse instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of OAuthDynamicClientResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OAuthDynamicClientResponse
   * @throws IOException if the JSON string is invalid with respect to OAuthDynamicClientResponse
   */
  public static OAuthDynamicClientResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OAuthDynamicClientResponse.class);
  }

  /**
   * Convert an instance of OAuthDynamicClientResponse to an JSON string
   *
   * @return JSON string
   */
