...
public class UserProfileKnownLoginVariables extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileKnownLoginVariables.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileKnownLoginVariables.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileKnownLoginVariables' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileKnownLoginVariables>() {
                @Override
                public void write(JsonWriter out, UserProfileKnownLoginVariables value) throws IOException {
                ...
                @Override
                public UserProfileKnownLoginVariables read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileKnownLoginVariables ret = new UserProfileKnownLoginVariables();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileKnownLoginVariables: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileKnownLoginVariables() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileKnownLoginVariables(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileKnownLoginVariables.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileKnownLoginVariables
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileKnownLoginVariables with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileKnownLoginVariables given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileKnownLoginVariables
     * @throws IOException if the JSON string is invalid with respect to UserProfileKnownLoginVariables
     */
    public static UserProfileKnownLoginVariables fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileKnownLoginVariables.class);
    }

    /**
     * Convert an instance of UserProfileKnownLoginVariables to an JSON string
     *
     * @return JSON string
     */
