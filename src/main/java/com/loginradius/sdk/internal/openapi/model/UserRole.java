...
public class UserRole {
   ...
   * @return the UserRole instance itself
   */
  public UserRole putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, userRole.id) &&
        ...
        Objects.equals(this.additionalProperties, userRole.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, uid, roleId, orgId, email, createdDate, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserRole>() {
           ...
           public UserRole read(JsonReader in) throws IOException {
             ...
             UserRole instance = thisAdapter.fromJsonTree(jsonObj);
