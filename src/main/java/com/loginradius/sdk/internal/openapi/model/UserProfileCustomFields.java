...
public class UserProfileCustomFields extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileCustomFields.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileCustomFields.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileCustomFields' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileCustomFields>() {
                @Override
                public void write(JsonWriter out, UserProfileCustomFields value) throws IOException {
                ...
                @Override
                public UserProfileCustomFields read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileCustomFields ret = new UserProfileCustomFields();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileCustomFields: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileCustomFields() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileCustomFields(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileCustomFields.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileCustomFields
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileCustomFields with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileCustomFields given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileCustomFields
     * @throws IOException if the JSON string is invalid with respect to UserProfileCustomFields
     */
    public static UserProfileCustomFields fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileCustomFields.class);
    }

    /**
     * Convert an instance of UserProfileCustomFields to an JSON string
     *
     * @return JSON string
     */
