...
public class UserProfilePhoneNumbers extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfilePhoneNumbers.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfilePhoneNumbers.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfilePhoneNumbers' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfilePhoneNumbers>() {
                @Override
                public void write(JsonWriter out, UserProfilePhoneNumbers value) throws IOException {
                ...
                @Override
                public UserProfilePhoneNumbers read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfilePhoneNumbers ret = new UserProfilePhoneNumbers();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfilePhoneNumbers: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfilePhoneNumbers() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfilePhoneNumbers(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfilePhoneNumbers.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfilePhoneNumbers
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfilePhoneNumbers with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfilePhoneNumbers given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfilePhoneNumbers
     * @throws IOException if the JSON string is invalid with respect to UserProfilePhoneNumbers
     */
    public static UserProfilePhoneNumbers fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfilePhoneNumbers.class);
    }

    /**
     * Convert an instance of UserProfilePhoneNumbers to an JSON string
     *
     * @return JSON string
     */
