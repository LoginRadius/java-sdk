...
public class UserProfileLanguages extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileLanguages.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileLanguages.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileLanguages' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileLanguages>() {
                @Override
                public void write(JsonWriter out, UserProfileLanguages value) throws IOException {
                ...
                @Override
                public UserProfileLanguages read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileLanguages ret = new UserProfileLanguages();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileLanguages: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileLanguages() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileLanguages(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileLanguages.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileLanguages
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileLanguages with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileLanguages given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileLanguages
     * @throws IOException if the JSON string is invalid with respect to UserProfileLanguages
     */
    public static UserProfileLanguages fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileLanguages.class);
    }

    /**
     * Convert an instance of UserProfileLanguages to an JSON string
     *
     * @return JSON string
     */
