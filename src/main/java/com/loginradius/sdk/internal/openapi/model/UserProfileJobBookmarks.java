...
public class UserProfileJobBookmarks extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileJobBookmarks.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileJobBookmarks.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileJobBookmarks' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileJobBookmarks>() {
                @Override
                public void write(JsonWriter out, UserProfileJobBookmarks value) throws IOException {
                ...
                @Override
                public UserProfileJobBookmarks read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileJobBookmarks ret = new UserProfileJobBookmarks();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileJobBookmarks: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileJobBookmarks() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileJobBookmarks(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileJobBookmarks.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileJobBookmarks
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileJobBookmarks with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileJobBookmarks given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileJobBookmarks
     * @throws IOException if the JSON string is invalid with respect to UserProfileJobBookmarks
     */
    public static UserProfileJobBookmarks fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileJobBookmarks.class);
    }

    /**
     * Convert an instance of UserProfileJobBookmarks to an JSON string
     *
     * @return JSON string
     */
