...
public class UserProfileRoleContext extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileRoleContext.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileRoleContext.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileRoleContext' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileRoleContext>() {
                @Override
                public void write(JsonWriter out, UserProfileRoleContext value) throws IOException {
                ...
                @Override
                public UserProfileRoleContext read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileRoleContext ret = new UserProfileRoleContext();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileRoleContext: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileRoleContext() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileRoleContext(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileRoleContext.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileRoleContext
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileRoleContext with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileRoleContext given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileRoleContext
     * @throws IOException if the JSON string is invalid with respect to UserProfileRoleContext
     */
    public static UserProfileRoleContext fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileRoleContext.class);
    }

    /**
     * Convert an instance of UserProfileRoleContext to an JSON string
     *
     * @return JSON string
     */
