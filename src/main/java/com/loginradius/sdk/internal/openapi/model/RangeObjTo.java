...
public class RangeObjTo extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(RangeObjTo.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!RangeObjTo.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'RangeObjTo' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<RangeObjTo>() {
                @Override
                public void write(JsonWriter out, RangeObjTo value) throws IOException {
                ...
                @Override
                public RangeObjTo read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        RangeObjTo ret = new RangeObjTo();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for RangeObjTo: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to RangeObjTo
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for RangeObjTo with oneOf schemas: BigDecimal, Integer, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of RangeObjTo given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of RangeObjTo
     * @throws IOException if the JSON string is invalid with respect to RangeObjTo
     */
    public static RangeObjTo fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, RangeObjTo.class);
    }

    /**
     * Convert an instance of RangeObjTo to an JSON string
     *
     * @return JSON string
     */
