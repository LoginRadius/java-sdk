...
public class UserProfileAwards extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileAwards.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileAwards.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileAwards' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileAwards>() {
                @Override
                public void write(JsonWriter out, UserProfileAwards value) throws IOException {
                ...
                @Override
                public UserProfileAwards read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileAwards ret = new UserProfileAwards();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileAwards: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileAwards() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileAwards(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileAwards.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileAwards
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileAwards with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileAwards given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileAwards
     * @throws IOException if the JSON string is invalid with respect to UserProfileAwards
     */
    public static UserProfileAwards fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileAwards.class);
    }

    /**
     * Convert an instance of UserProfileAwards to an JSON string
     *
     * @return JSON string
     */
