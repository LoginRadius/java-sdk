...
public class UserProfileRecommendationsReceived extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileRecommendationsReceived.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileRecommendationsReceived.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileRecommendationsReceived' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileRecommendationsReceived>() {
                @Override
                public void write(JsonWriter out, UserProfileRecommendationsReceived value) throws IOException {
                ...
                @Override
                public UserProfileRecommendationsReceived read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileRecommendationsReceived ret = new UserProfileRecommendationsReceived();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileRecommendationsReceived: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileRecommendationsReceived() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileRecommendationsReceived(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileRecommendationsReceived.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileRecommendationsReceived
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileRecommendationsReceived with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileRecommendationsReceived given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileRecommendationsReceived
     * @throws IOException if the JSON string is invalid with respect to UserProfileRecommendationsReceived
     */
    public static UserProfileRecommendationsReceived fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileRecommendationsReceived.class);
    }

    /**
     * Convert an instance of UserProfileRecommendationsReceived to an JSON string
     *
     * @return JSON string
     */
