...
public class UserProfilePlacesLived extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfilePlacesLived.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfilePlacesLived.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfilePlacesLived' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfilePlacesLived>() {
                @Override
                public void write(JsonWriter out, UserProfilePlacesLived value) throws IOException {
                ...
                @Override
                public UserProfilePlacesLived read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfilePlacesLived ret = new UserProfilePlacesLived();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfilePlacesLived: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfilePlacesLived() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfilePlacesLived(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfilePlacesLived.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfilePlacesLived
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfilePlacesLived with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfilePlacesLived given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfilePlacesLived
     * @throws IOException if the JSON string is invalid with respect to UserProfilePlacesLived
     */
    public static UserProfilePlacesLived fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfilePlacesLived.class);
    }

    /**
     * Convert an instance of UserProfilePlacesLived to an JSON string
     *
     * @return JSON string
     */
