...
public class UserProfileProjects extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileProjects.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileProjects.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileProjects' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileProjects>() {
                @Override
                public void write(JsonWriter out, UserProfileProjects value) throws IOException {
                ...
                @Override
                public UserProfileProjects read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileProjects ret = new UserProfileProjects();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileProjects: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileProjects() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileProjects(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileProjects.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileProjects
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileProjects with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileProjects given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileProjects
     * @throws IOException if the JSON string is invalid with respect to UserProfileProjects
     */
    public static UserProfileProjects fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileProjects.class);
    }

    /**
     * Convert an instance of UserProfileProjects to an JSON string
     *
     * @return JSON string
     */
