...
import com.loginradius.sdk.internal.openapi.model.ActiveSession;
...
public class ActiveSessionResponse {
  ...
  @javax.annotation.Nullable
  private List<ActiveSession> data = new ArrayList<>();

  public ActiveSessionResponse() {
  }

  public ActiveSessionResponse nextCursor(@javax.annotation.Nullable Integer nextCursor) {
  ...
  public ActiveSessionResponse data(@javax.annotation.Nullable List<ActiveSession> data) {
    this.data = data;
    return this;
  }

  public ActiveSessionResponse addDataItem(ActiveSession dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ActiveSession> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<ActiveSession> data) {
    this.data = data;
  }
   ...
   * @return the ActiveSessionResponse instance itself
   */
  public ActiveSessionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextCursor, activeSessionResponse.nextCursor) &&
        Objects.equals(this.data, activeSessionResponse.data)&&
        Objects.equals(this.additionalProperties, activeSessionResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextCursor, data, additionalProperties);
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ActiveSession.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ActiveSessionResponse>() {
           ...
           public ActiveSessionResponse read(JsonReader in) throws IOException {
             ...
             ActiveSessionResponse instance = thisAdapter.fromJsonTree(jsonObj);
