...
import com.loginradius.sdk.internal.openapi.model.AccessTokenSessionToken;
...
public class AccessToken {
  ...
  @javax.annotation.Nullable
  private AccessTokenSessionToken sessionToken;

  public AccessToken() {
  }

  public AccessToken accessToken(@javax.annotation.Nullable String accessToken) {
  ...
  public AccessToken refreshToken(@javax.annotation.Nullable String refreshToken) {
  ...
  public AccessToken expiresIn(@javax.annotation.Nullable OffsetDateTime expiresIn) {
  ...
  public AccessToken sessionToken(@javax.annotation.Nullable AccessTokenSessionToken sessionToken) {
   ...
   */
  @javax.annotation.Nullable
  public AccessTokenSessionToken getSessionToken() {
    return sessionToken;
  }

  public void setSessionToken(@javax.annotation.Nullable AccessTokenSessionToken sessionToken) {
    this.sessionToken = sessionToken;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessToken, accessToken.accessToken) &&
        ...
        Objects.equals(this.sessionToken, accessToken.sessionToken)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessToken, refreshToken, expiresIn, sessionToken, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("SessionToken") != null && !jsonObj.get("SessionToken").isJsonNull()) {
        AccessTokenSessionToken.validateJsonElement(jsonObj.get("SessionToken"));
      }
  }
