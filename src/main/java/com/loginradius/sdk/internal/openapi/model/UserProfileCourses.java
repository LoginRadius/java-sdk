...
public class UserProfileCourses extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileCourses.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileCourses.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileCourses' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileCourses>() {
                @Override
                public void write(JsonWriter out, UserProfileCourses value) throws IOException {
                ...
                @Override
                public UserProfileCourses read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileCourses ret = new UserProfileCourses();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileCourses: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileCourses() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileCourses(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileCourses.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileCourses
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileCourses with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileCourses given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileCourses
     * @throws IOException if the JSON string is invalid with respect to UserProfileCourses
     */
    public static UserProfileCourses fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileCourses.class);
    }

    /**
     * Convert an instance of UserProfileCourses to an JSON string
     *
     * @return JSON string
     */
