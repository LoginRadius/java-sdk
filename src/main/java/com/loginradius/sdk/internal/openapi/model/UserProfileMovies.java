...
public class UserProfileMovies extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileMovies.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileMovies.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileMovies' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileMovies>() {
                @Override
                public void write(JsonWriter out, UserProfileMovies value) throws IOException {
                ...
                @Override
                public UserProfileMovies read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileMovies ret = new UserProfileMovies();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileMovies: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileMovies() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileMovies(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileMovies.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileMovies
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileMovies with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileMovies given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileMovies
     * @throws IOException if the JSON string is invalid with respect to UserProfileMovies
     */
    public static UserProfileMovies fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileMovies.class);
    }

    /**
     * Convert an instance of UserProfileMovies to an JSON string
     *
     * @return JSON string
     */
