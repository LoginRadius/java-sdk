...
import com.loginradius.sdk.internal.openapi.model.UserProfile;
...
public class UserProfileResponse {
  ...
  public UserProfileResponse data(@javax.annotation.Nullable List<UserProfile> data) {
    this.data = data;
    return this;
  }

  public UserProfileResponse addDataItem(UserProfile dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nullable List<UserProfile> data) {
    this.data = data;
  }


  public UserProfileResponse next(@javax.annotation.Nullable String next) {
    this.next = next;
    return this;
  }
   ...
   * @return the UserProfileResponse instance itself
   */
  public UserProfileResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, userProfileResponse.data) &&
        Objects.equals(this.next, userProfileResponse.next)&&
        Objects.equals(this.additionalProperties, userProfileResponse.additionalProperties);
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            UserProfile.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserProfileResponse>() {
           ...
           public UserProfileResponse read(JsonReader in) throws IOException {
             ...
             UserProfileResponse instance = thisAdapter.fromJsonTree(jsonObj);
