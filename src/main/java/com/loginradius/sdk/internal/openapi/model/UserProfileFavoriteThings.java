...
public class UserProfileFavoriteThings extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileFavoriteThings.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileFavoriteThings.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileFavoriteThings' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileFavoriteThings>() {
                @Override
                public void write(JsonWriter out, UserProfileFavoriteThings value) throws IOException {
                ...
                @Override
                public UserProfileFavoriteThings read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileFavoriteThings ret = new UserProfileFavoriteThings();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileFavoriteThings: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileFavoriteThings() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileFavoriteThings(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileFavoriteThings.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileFavoriteThings
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileFavoriteThings with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileFavoriteThings given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileFavoriteThings
     * @throws IOException if the JSON string is invalid with respect to UserProfileFavoriteThings
     */
    public static UserProfileFavoriteThings fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileFavoriteThings.class);
    }

    /**
     * Convert an instance of UserProfileFavoriteThings to an JSON string
     *
     * @return JSON string
     */
