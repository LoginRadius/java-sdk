...
public class UserProfileMutualFriends extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileMutualFriends.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileMutualFriends.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileMutualFriends' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileMutualFriends>() {
                @Override
                public void write(JsonWriter out, UserProfileMutualFriends value) throws IOException {
                ...
                @Override
                public UserProfileMutualFriends read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileMutualFriends ret = new UserProfileMutualFriends();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileMutualFriends: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileMutualFriends() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileMutualFriends(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileMutualFriends.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileMutualFriends
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileMutualFriends with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileMutualFriends given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileMutualFriends
     * @throws IOException if the JSON string is invalid with respect to UserProfileMutualFriends
     */
    public static UserProfileMutualFriends fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileMutualFriends.class);
    }

    /**
     * Convert an instance of UserProfileMutualFriends to an JSON string
     *
     * @return JSON string
     */
