...
public class UserProfileProfileImageUrls extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileProfileImageUrls.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileProfileImageUrls.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileProfileImageUrls' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileProfileImageUrls>() {
                @Override
                public void write(JsonWriter out, UserProfileProfileImageUrls value) throws IOException {
                ...
                @Override
                public UserProfileProfileImageUrls read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileProfileImageUrls ret = new UserProfileProfileImageUrls();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileProfileImageUrls: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileProfileImageUrls() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileProfileImageUrls(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileProfileImageUrls.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileProfileImageUrls
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileProfileImageUrls with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileProfileImageUrls given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileProfileImageUrls
     * @throws IOException if the JSON string is invalid with respect to UserProfileProfileImageUrls
     */
    public static UserProfileProfileImageUrls fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileProfileImageUrls.class);
    }

    /**
     * Convert an instance of UserProfileProfileImageUrls to an JSON string
     *
     * @return JSON string
     */
