...
public class UserProfileIMAccounts extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileIMAccounts.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileIMAccounts.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileIMAccounts' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileIMAccounts>() {
                @Override
                public void write(JsonWriter out, UserProfileIMAccounts value) throws IOException {
                ...
                @Override
                public UserProfileIMAccounts read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileIMAccounts ret = new UserProfileIMAccounts();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileIMAccounts: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileIMAccounts() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileIMAccounts(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileIMAccounts.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileIMAccounts
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileIMAccounts with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileIMAccounts given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileIMAccounts
     * @throws IOException if the JSON string is invalid with respect to UserProfileIMAccounts
     */
    public static UserProfileIMAccounts fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileIMAccounts.class);
    }

    /**
     * Convert an instance of UserProfileIMAccounts to an JSON string
     *
     * @return JSON string
     */
