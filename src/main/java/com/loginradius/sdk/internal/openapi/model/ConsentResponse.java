...
public class ConsentResponse {
  ...
  public ConsentResponse profile(@javax.annotation.Nullable Profile profile) {
  ...
  public ConsentResponse accessToken(@javax.annotation.Nullable String accessToken) {
  ...
  public ConsentResponse refreshToken(@javax.annotation.Nullable String refreshToken) {
  ...
  public ConsentResponse expiresIn(@javax.annotation.Nullable String expiresIn) {
   ...
   * @return the ConsentResponse instance itself
   */
  public ConsentResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.profile, consentResponse.profile) &&
        Objects.equals(this.accessToken, consentResponse.accessToken) &&
        Objects.equals(this.refreshToken, consentResponse.refreshToken) &&
        Objects.equals(this.expiresIn, consentResponse.expiresIn)&&
        Objects.equals(this.additionalProperties, consentResponse.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConsentResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConsentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConsentResponse>() {
           ...
           public ConsentResponse read(JsonReader in) throws IOException {
             ...
             ConsentResponse instance = thisAdapter.fromJsonTree(jsonObj);
