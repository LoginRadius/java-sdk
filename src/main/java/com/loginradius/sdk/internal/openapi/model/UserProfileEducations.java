...
public class UserProfileEducations extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileEducations.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileEducations.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileEducations' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileEducations>() {
                @Override
                public void write(JsonWriter out, UserProfileEducations value) throws IOException {
                ...
                @Override
                public UserProfileEducations read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileEducations ret = new UserProfileEducations();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileEducations: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileEducations() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileEducations(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileEducations.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileEducations
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileEducations with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileEducations given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileEducations
     * @throws IOException if the JSON string is invalid with respect to UserProfileEducations
     */
    public static UserProfileEducations fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileEducations.class);
    }

    /**
     * Convert an instance of UserProfileEducations to an JSON string
     *
     * @return JSON string
     */
