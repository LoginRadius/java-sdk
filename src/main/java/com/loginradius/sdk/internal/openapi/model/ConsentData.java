...
public class ConsentData {
  public static final String SERIALIZED_NAME_CONSENTOPTIONID = "consentoptionid";
  @SerializedName(SERIALIZED_NAME_CONSENTOPTIONID)
  @javax.annotation.Nonnull
  private String consentoptionid;

  public static final String SERIALIZED_NAME_ISACCEPTED = "isaccepted";
  @SerializedName(SERIALIZED_NAME_ISACCEPTED)
  @javax.annotation.Nonnull
  ...
  public ConsentData consentoptionid(@javax.annotation.Nonnull String consentoptionid) {
  ...
  public void setConsentoptionid(@javax.annotation.Nonnull String consentoptionid) {
    this.consentoptionid = consentoptionid;
  }


  public ConsentData isaccepted(@javax.annotation.Nonnull Boolean isaccepted) {
  ...
  public void setIsaccepted(@javax.annotation.Nonnull Boolean isaccepted) {
    this.isaccepted = isaccepted;
  }
   ...
   * @return the ConsentData instance itself
   */
  public ConsentData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.consentoptionid, consentData.consentoptionid) &&
        Objects.equals(this.isaccepted, consentData.isaccepted)&&
        Objects.equals(this.additionalProperties, consentData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(consentoptionid, isaccepted, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("consentoptionid");
    openapiRequiredFields.add("isaccepted");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : ConsentData.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("consentoptionid").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConsentData>() {
           ...
           public ConsentData read(JsonReader in) throws IOException {
             ...
             ConsentData instance = thisAdapter.fromJsonTree(jsonObj);
