...
public class UserProfileSuggestions extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileSuggestions.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileSuggestions.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileSuggestions' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileSuggestions>() {
                @Override
                public void write(JsonWriter out, UserProfileSuggestions value) throws IOException {
                ...
                @Override
                public UserProfileSuggestions read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileSuggestions ret = new UserProfileSuggestions();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileSuggestions: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileSuggestions() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileSuggestions(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileSuggestions.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileSuggestions
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileSuggestions with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileSuggestions given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileSuggestions
     * @throws IOException if the JSON string is invalid with respect to UserProfileSuggestions
     */
    public static UserProfileSuggestions fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileSuggestions.class);
    }

    /**
     * Convert an instance of UserProfileSuggestions to an JSON string
     *
     * @return JSON string
     */
