...
public class UserProfileAddresses extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileAddresses.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileAddresses.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileAddresses' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileAddresses>() {
                @Override
                public void write(JsonWriter out, UserProfileAddresses value) throws IOException {
                ...
                @Override
                public UserProfileAddresses read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileAddresses ret = new UserProfileAddresses();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileAddresses: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileAddresses() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileAddresses(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileAddresses.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileAddresses
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileAddresses with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileAddresses given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileAddresses
     * @throws IOException if the JSON string is invalid with respect to UserProfileAddresses
     */
    public static UserProfileAddresses fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileAddresses.class);
    }

    /**
     * Convert an instance of UserProfileAddresses to an JSON string
     *
     * @return JSON string
     */
