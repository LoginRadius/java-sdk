...
public class UserProfileGames extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileGames.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileGames.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileGames' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileGames>() {
                @Override
                public void write(JsonWriter out, UserProfileGames value) throws IOException {
                ...
                @Override
                public UserProfileGames read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileGames ret = new UserProfileGames();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileGames: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileGames() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileGames(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileGames.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileGames
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileGames with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileGames given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileGames
     * @throws IOException if the JSON string is invalid with respect to UserProfileGames
     */
    public static UserProfileGames fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileGames.class);
    }

    /**
     * Convert an instance of UserProfileGames to an JSON string
     *
     * @return JSON string
     */
