...
public class UserProfileSkills extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileSkills.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileSkills.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileSkills' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileSkills>() {
                @Override
                public void write(JsonWriter out, UserProfileSkills value) throws IOException {
                ...
                @Override
                public UserProfileSkills read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileSkills ret = new UserProfileSkills();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileSkills: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileSkills() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileSkills(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileSkills.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileSkills
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileSkills with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileSkills given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileSkills
     * @throws IOException if the JSON string is invalid with respect to UserProfileSkills
     */
    public static UserProfileSkills fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileSkills.class);
    }

    /**
     * Convert an instance of UserProfileSkills to an JSON string
     *
     * @return JSON string
     */
