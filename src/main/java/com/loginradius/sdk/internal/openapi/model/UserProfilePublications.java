...
public class UserProfilePublications extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfilePublications.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfilePublications.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfilePublications' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfilePublications>() {
                @Override
                public void write(JsonWriter out, UserProfilePublications value) throws IOException {
                ...
                @Override
                public UserProfilePublications read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfilePublications ret = new UserProfilePublications();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfilePublications: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfilePublications() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfilePublications(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfilePublications.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfilePublications
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfilePublications with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfilePublications given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfilePublications
     * @throws IOException if the JSON string is invalid with respect to UserProfilePublications
     */
    public static UserProfilePublications fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfilePublications.class);
    }

    /**
     * Convert an instance of UserProfilePublications to an JSON string
     *
     * @return JSON string
     */
