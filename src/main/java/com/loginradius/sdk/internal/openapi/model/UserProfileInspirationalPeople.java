...
public class UserProfileInspirationalPeople extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileInspirationalPeople.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileInspirationalPeople.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileInspirationalPeople' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileInspirationalPeople>() {
                @Override
                public void write(JsonWriter out, UserProfileInspirationalPeople value) throws IOException {
                ...
                @Override
                public UserProfileInspirationalPeople read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileInspirationalPeople ret = new UserProfileInspirationalPeople();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileInspirationalPeople: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileInspirationalPeople() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileInspirationalPeople(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileInspirationalPeople.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileInspirationalPeople
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileInspirationalPeople with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileInspirationalPeople given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileInspirationalPeople
     * @throws IOException if the JSON string is invalid with respect to UserProfileInspirationalPeople
     */
    public static UserProfileInspirationalPeople fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileInspirationalPeople.class);
    }

    /**
     * Convert an instance of UserProfileInspirationalPeople to an JSON string
     *
     * @return JSON string
     */
