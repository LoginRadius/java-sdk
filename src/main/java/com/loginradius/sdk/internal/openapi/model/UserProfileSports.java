...
public class UserProfileSports extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileSports.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileSports.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileSports' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileSports>() {
                @Override
                public void write(JsonWriter out, UserProfileSports value) throws IOException {
                ...
                @Override
                public UserProfileSports read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileSports ret = new UserProfileSports();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileSports: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileSports() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileSports(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileSports.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileSports
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileSports with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileSports given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileSports
     * @throws IOException if the JSON string is invalid with respect to UserProfileSports
     */
    public static UserProfileSports fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileSports.class);
    }

    /**
     * Convert an instance of UserProfileSports to an JSON string
     *
     * @return JSON string
     */
