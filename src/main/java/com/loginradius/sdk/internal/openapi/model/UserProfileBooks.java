...
public class UserProfileBooks extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileBooks.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileBooks.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileBooks' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileBooks>() {
                @Override
                public void write(JsonWriter out, UserProfileBooks value) throws IOException {
                ...
                @Override
                public UserProfileBooks read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileBooks ret = new UserProfileBooks();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileBooks: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileBooks() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileBooks(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileBooks.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileBooks
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileBooks with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileBooks given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileBooks
     * @throws IOException if the JSON string is invalid with respect to UserProfileBooks
     */
    public static UserProfileBooks fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileBooks.class);
    }

    /**
     * Convert an instance of UserProfileBooks to an JSON string
     *
     * @return JSON string
     */
