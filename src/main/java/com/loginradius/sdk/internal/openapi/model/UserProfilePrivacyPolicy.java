...
public class UserProfilePrivacyPolicy extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfilePrivacyPolicy.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfilePrivacyPolicy.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfilePrivacyPolicy' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfilePrivacyPolicy>() {
                @Override
                public void write(JsonWriter out, UserProfilePrivacyPolicy value) throws IOException {
                ...
                @Override
                public UserProfilePrivacyPolicy read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfilePrivacyPolicy ret = new UserProfilePrivacyPolicy();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfilePrivacyPolicy: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfilePrivacyPolicy() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfilePrivacyPolicy(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfilePrivacyPolicy.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfilePrivacyPolicy
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfilePrivacyPolicy with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfilePrivacyPolicy given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfilePrivacyPolicy
     * @throws IOException if the JSON string is invalid with respect to UserProfilePrivacyPolicy
     */
    public static UserProfilePrivacyPolicy fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfilePrivacyPolicy.class);
    }

    /**
     * Convert an instance of UserProfilePrivacyPolicy to an JSON string
     *
     * @return JSON string
     */
