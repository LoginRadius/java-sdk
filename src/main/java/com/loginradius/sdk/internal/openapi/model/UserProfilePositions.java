...
public class UserProfilePositions extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfilePositions.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfilePositions.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfilePositions' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfilePositions>() {
                @Override
                public void write(JsonWriter out, UserProfilePositions value) throws IOException {
                ...
                @Override
                public UserProfilePositions read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfilePositions ret = new UserProfilePositions();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfilePositions: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfilePositions() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfilePositions(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfilePositions.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfilePositions
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfilePositions with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfilePositions given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfilePositions
     * @throws IOException if the JSON string is invalid with respect to UserProfilePositions
     */
    public static UserProfilePositions fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfilePositions.class);
    }

    /**
     * Convert an instance of UserProfilePositions to an JSON string
     *
     * @return JSON string
     */
