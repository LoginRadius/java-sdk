...
public class UserProfileWebProfiles extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileWebProfiles.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileWebProfiles.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileWebProfiles' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileWebProfiles>() {
                @Override
                public void write(JsonWriter out, UserProfileWebProfiles value) throws IOException {
                ...
                @Override
                public UserProfileWebProfiles read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileWebProfiles ret = new UserProfileWebProfiles();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileWebProfiles: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileWebProfiles() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileWebProfiles(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileWebProfiles.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileWebProfiles
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileWebProfiles with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileWebProfiles given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileWebProfiles
     * @throws IOException if the JSON string is invalid with respect to UserProfileWebProfiles
     */
    public static UserProfileWebProfiles fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileWebProfiles.class);
    }

    /**
     * Convert an instance of UserProfileWebProfiles to an JSON string
     *
     * @return JSON string
     */
