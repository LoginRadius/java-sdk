...
public class UserProfileMemberUrlResources extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileMemberUrlResources.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileMemberUrlResources.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileMemberUrlResources' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileMemberUrlResources>() {
                @Override
                public void write(JsonWriter out, UserProfileMemberUrlResources value) throws IOException {
                ...
                @Override
                public UserProfileMemberUrlResources read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileMemberUrlResources ret = new UserProfileMemberUrlResources();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileMemberUrlResources: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileMemberUrlResources() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileMemberUrlResources(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileMemberUrlResources.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileMemberUrlResources
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileMemberUrlResources with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileMemberUrlResources given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileMemberUrlResources
     * @throws IOException if the JSON string is invalid with respect to UserProfileMemberUrlResources
     */
    public static UserProfileMemberUrlResources fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileMemberUrlResources.class);
    }

    /**
     * Convert an instance of UserProfileMemberUrlResources to an JSON string
     *
     * @return JSON string
     */
