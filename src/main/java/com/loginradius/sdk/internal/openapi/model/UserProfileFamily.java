...
public class UserProfileFamily extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileFamily.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileFamily.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileFamily' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileFamily>() {
                @Override
                public void write(JsonWriter out, UserProfileFamily value) throws IOException {
                ...
                @Override
                public UserProfileFamily read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileFamily ret = new UserProfileFamily();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileFamily: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileFamily() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileFamily(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileFamily.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileFamily
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileFamily with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileFamily given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileFamily
     * @throws IOException if the JSON string is invalid with respect to UserProfileFamily
     */
    public static UserProfileFamily fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileFamily.class);
    }

    /**
     * Convert an instance of UserProfileFamily to an JSON string
     *
     * @return JSON string
     */
