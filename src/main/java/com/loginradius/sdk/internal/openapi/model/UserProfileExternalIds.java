...
public class UserProfileExternalIds extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileExternalIds.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileExternalIds.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileExternalIds' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileExternalIds>() {
                @Override
                public void write(JsonWriter out, UserProfileExternalIds value) throws IOException {
                ...
                @Override
                public UserProfileExternalIds read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileExternalIds ret = new UserProfileExternalIds();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileExternalIds: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileExternalIds() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileExternalIds(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileExternalIds.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileExternalIds
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileExternalIds with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileExternalIds given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileExternalIds
     * @throws IOException if the JSON string is invalid with respect to UserProfileExternalIds
     */
    public static UserProfileExternalIds fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileExternalIds.class);
    }

    /**
     * Convert an instance of UserProfileExternalIds to an JSON string
     *
     * @return JSON string
     */
