...
public class RangeObjFrom extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(RangeObjFrom.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!RangeObjFrom.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'RangeObjFrom' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<RangeObjFrom>() {
                @Override
                public void write(JsonWriter out, RangeObjFrom value) throws IOException {
                ...
                @Override
                public RangeObjFrom read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        RangeObjFrom ret = new RangeObjFrom();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for RangeObjFrom: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to RangeObjFrom
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for RangeObjFrom with oneOf schemas: BigDecimal, Integer, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of RangeObjFrom given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of RangeObjFrom
     * @throws IOException if the JSON string is invalid with respect to RangeObjFrom
     */
    public static RangeObjFrom fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, RangeObjFrom.class);
    }

    /**
     * Convert an instance of RangeObjFrom to an JSON string
     *
     * @return JSON string
     */
