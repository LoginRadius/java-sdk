...
public class UserProfileCertifications extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileCertifications.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileCertifications.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileCertifications' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileCertifications>() {
                @Override
                public void write(JsonWriter out, UserProfileCertifications value) throws IOException {
                ...
                @Override
                public UserProfileCertifications read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileCertifications ret = new UserProfileCertifications();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileCertifications: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileCertifications() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileCertifications(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileCertifications.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileCertifications
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileCertifications with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileCertifications given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileCertifications
     * @throws IOException if the JSON string is invalid with respect to UserProfileCertifications
     */
    public static UserProfileCertifications fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileCertifications.class);
    }

    /**
     * Convert an instance of UserProfileCertifications to an JSON string
     *
     * @return JSON string
     */
