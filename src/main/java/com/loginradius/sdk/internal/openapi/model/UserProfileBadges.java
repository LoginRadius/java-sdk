...
public class UserProfileBadges extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileBadges.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileBadges.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileBadges' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileBadges>() {
                @Override
                public void write(JsonWriter out, UserProfileBadges value) throws IOException {
                ...
                @Override
                public UserProfileBadges read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileBadges ret = new UserProfileBadges();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileBadges: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileBadges() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileBadges(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UserProfileBadges.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileBadges
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileBadges with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileBadges given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileBadges
     * @throws IOException if the JSON string is invalid with respect to UserProfileBadges
     */
    public static UserProfileBadges fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileBadges.class);
    }

    /**
     * Convert an instance of UserProfileBadges to an JSON string
     *
     * @return JSON string
     */
