...
public class UserProfileTeleVisionShow extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UserProfileTeleVisionShow.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UserProfileTeleVisionShow.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UserProfileTeleVisionShow' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UserProfileTeleVisionShow>() {
                @Override
                public void write(JsonWriter out, UserProfileTeleVisionShow value) throws IOException {
                ...
                @Override
                public UserProfileTeleVisionShow read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        UserProfileTeleVisionShow ret = new UserProfileTeleVisionShow();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for UserProfileTeleVisionShow: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UserProfileTeleVisionShow() {
        super("oneOf", Boolean.FALSE);
    }

    public UserProfileTeleVisionShow(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserProfileTeleVisionShow
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for UserProfileTeleVisionShow with oneOf schemas: List<Object>, Object. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of UserProfileTeleVisionShow given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UserProfileTeleVisionShow
     * @throws IOException if the JSON string is invalid with respect to UserProfileTeleVisionShow
     */
    public static UserProfileTeleVisionShow fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UserProfileTeleVisionShow.class);
    }

    /**
     * Convert an instance of UserProfileTeleVisionShow to an JSON string
     *
     * @return JSON string
     */
