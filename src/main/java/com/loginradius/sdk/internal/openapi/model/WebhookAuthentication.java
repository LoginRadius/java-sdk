...
import com.loginradius.sdk.internal.openapi.model.BasicAuthWebhook;
import com.loginradius.sdk.internal.openapi.model.Bearertoken;
...
public class WebhookAuthentication {
  ...
  @javax.annotation.Nullable
  private BasicAuthWebhook basicAuth;
  ...
  public WebhookAuthentication authType(@javax.annotation.Nullable AuthTypeEnum authType) {
  ...
  public WebhookAuthentication basicAuth(@javax.annotation.Nullable BasicAuthWebhook basicAuth) {
   ...
   */
  @javax.annotation.Nullable
  public BasicAuthWebhook getBasicAuth() {
    return basicAuth;
  }

  public void setBasicAuth(@javax.annotation.Nullable BasicAuthWebhook basicAuth) {
    this.basicAuth = basicAuth;
  }


  public WebhookAuthentication bearerToken(@javax.annotation.Nullable Bearertoken bearerToken) {
  ...
  public void setBearerToken(@javax.annotation.Nullable Bearertoken bearerToken) {
    this.bearerToken = bearerToken;
  }
   ...
   * @return the WebhookAuthentication instance itself
   */
  public WebhookAuthentication putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authType, webhookAuthentication.authType) &&
        Objects.equals(this.basicAuth, webhookAuthentication.basicAuth) &&
        Objects.equals(this.bearerToken, webhookAuthentication.bearerToken)&&
        Objects.equals(this.additionalProperties, webhookAuthentication.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authType, basicAuth, bearerToken, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("BasicAuth") != null && !jsonObj.get("BasicAuth").isJsonNull()) {
        BasicAuthWebhook.validateJsonElement(jsonObj.get("BasicAuth"));
      }
      // validate the optional field `BearerToken`
      if (jsonObj.get("BearerToken") != null && !jsonObj.get("BearerToken").isJsonNull()) {
        Bearertoken.validateJsonElement(jsonObj.get("BearerToken"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookAuthentication>() {
           ...
           public WebhookAuthentication read(JsonReader in) throws IOException {
             ...
             WebhookAuthentication instance = thisAdapter.fromJsonTree(jsonObj);
